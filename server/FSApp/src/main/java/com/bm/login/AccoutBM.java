...
public class AccoutBM {
	...
	public boolean validateAccout(TableAccount account){
		boolean passed = false;
		TableAccount fromDB = getByAccountId(account.getAccount());
		if(fromDB!=null && StringUtils.equals(fromDB.getPassword(), account.getPassword())){
			passed = true;
		}
	...
	public boolean isAccountExist(String account){
		TableAccount fromDB = getByAccountId(account);
		return fromDB!=null;
