...
//	final private String template="$logTime$|core_stat_2|$loginZoneId$|$logTime$|stat_role_level|$loginZoneId$|$regChannelId$|$level$|$levelCount$|$loginClientPlatForm$";
	...
	final private String template=LogTemplate.ZoneCountLevelSpreadLogTemplate;
	...
	public static void main(String[] args) {
		String ZoneCountLevelSpreadLogTemplate = "打印时间|core_stat_2|用户登录区ID|日志的触发时间|stat_role_level|用户登录区ID|注册渠道ID|用户角色等级|角色统计|4=安卓/5=ios/7=wm";
		BILogTemplateHelper.toTemplate(ZoneCountLevelSpreadLogTemplate);
	}
}
