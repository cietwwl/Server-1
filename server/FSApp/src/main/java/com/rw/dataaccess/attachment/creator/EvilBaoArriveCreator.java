...
public class EvilBaoArriveCreator implements PlayerExtPropertyCreator<EvilBaoArriveItem>{
	...
	@Override
	public List<EvilBaoArriveItem> firstCreate(
			PlayerPropertyParams params) {
		List<EvilBaoArriveItem> itemList = new ArrayList<EvilBaoArriveItem>();
		return itemList;
	}

	@Override
	public List<EvilBaoArriveItem> checkAndCreate(
			RoleExtPropertyStore<EvilBaoArriveItem> store,
			PlayerPropertyParams params) {
		return null;
	}
}
