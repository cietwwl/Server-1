...
public class ActivityChargeRankService implements FsService<ActivityCommonReqMsg, RequestType> {

	@Override
	public ByteString doTask(ActivityCommonReqMsg request, Player player) {
		ActivityChargeRankHandler handler = ActivityChargeRankHandler.getInstance();
