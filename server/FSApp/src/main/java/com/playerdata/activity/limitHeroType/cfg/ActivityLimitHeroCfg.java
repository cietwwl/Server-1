...
public class ActivityLimitHeroCfg {
	...
	private int singleplan;//单抽方案
	
	private int tenplan;//十连方案
	
	private int singlecost;//单抽消耗钻石
	
	private int tencost;//十连消耗钻石
	
	private int singleintegral;//单抽涨分
	
	private int tenintegral;//十连涨分
	
	private int freecd;//免费cd
	...
	public int getSingleplan() {
		return singleplan;
	}

	public void setSingleplan(int singleplan) {
		this.singleplan = singleplan;
	}

	public int getTenplan() {
		return tenplan;
	}

	public void setTenplan(int tenplan) {
		this.tenplan = tenplan;
	}
	...
	public void setTencost(int tencost) {
