...
public class FashionEffectCfg {
	...
	public void ExtraInit() {
		...
		collectValue(sourceValues,sourcePer,attrValueType1Field,attrName1,attrValue1);
		collectValue(sourceValues,sourcePer,attrValueType2Field,attrName2,attrValue2);
		collectValue(sourceValues,sourcePer,attrValueType3Field,attrName3,attrValue3);
		collectValue(sourceValues,sourcePer,attrValueType4Field,attrName4,attrValue4);
		collectValue(sourceValues,sourcePer,attrValueType5Field,attrName5,attrValue5);
		BeanCopyer.SetFields(sourceValues , addedValues, null);
		BeanCopyer.SetFields(sourcePer , addedPercentages, null);
	}

	private void collectValue(List<IReadOnlyPair<String, Object>> sourceValues,
	...
	public AttrData getAddedValues() {
		return addedValues;
	}

	public AttrData getAddedPercentages() {
