...
public enum UserEventType {
	...
	GoldSpendingVitality,//消费xx钻石
	GivePowerVitality,//赠送体力x次
	TreasureLandVitality,//聚宝之地通关x次
	TowerVitality,//万仙得xx徽记
	BattleTowerVitality,//封神通关第x层
	...
	UseSweepTicketVitality,//使用扫荡券xx张
	LearnSkillInfactionVitality,//在帮派学习技能x次
