package com.rw.fsutil.util.jackson;
...
public class JsonUtil {
	...
	public static <T> List<T> readList(String value, Class<T> Object){
		if (value != null && !value.trim().equals("")) {
			try {
//				CollectionType constructMapType = ArrayType.construct(componentType, valueHandler, typeHandler).getTypeFactory().constructMapType(Map.class, String.class , Object);
