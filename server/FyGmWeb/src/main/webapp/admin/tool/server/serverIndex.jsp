...
<frameset rows="35,*" id="frame" framespacing="0" frameborder="no">
	<frame src="<%=response.encodeURL(request.getContextPath()+"/admin/tool/server/serverMenuList.jsp")%>" name="leftFrame" marginwidth="0" noresize="noresize" frameborder="0" scrolling="auto"/>
