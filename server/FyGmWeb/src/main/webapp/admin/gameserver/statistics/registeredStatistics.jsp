...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover">
	<tbody id="_table">
	</tbody>		
</table>
...
function query(){
	...
	GameServerStatisticsAction.queryGameServerRegistered(begin, end, serverId, pid, callBack);
}
