...
<body>
	<center>
	<h1>回滚上一次的资源</h1>
	<form method="post" action="<%=response.encodeURL(request.getContextPath() + "/admin/clientrollback.a")%>" enctype="multipart/form-data" accept-charset="utf-8">
		<input type="submit"  value="回滚"/><br/>
	</form>
	</center>
</body>
</html>