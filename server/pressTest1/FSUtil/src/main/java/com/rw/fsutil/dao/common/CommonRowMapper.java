...
class CommonRowMapper<T> implements RowMapper<T> {
		...
		try {
			...
			for (Entry<String, String> entry : entrySet) {
				...
				if(field!=null){
					...
					Object objValue = JsonUtil.readValue(jsonValue, field.getType());				
			...
			StringBuilder message = new StringBuilder().append("CommonRowMapper[handleCombineSave] error, ")
														.append(" class:").append(newInstance.getClass())
	...
	private void handleSingleSave(T newInstance, String columnName, Object value) {
		...
		try {
			...
			StringBuilder message = new StringBuilder().append("CommonRowMapper[handleSingleSave] error, ")
								.append(" class:").append(newInstance.getClass())
								.append(" columnName:").append(columnName)
								.append(" value:").append(value);
			SqlLog.error(message.toString(), e);
