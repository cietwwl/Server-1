...
public class RedPointManager {
	...
	public Map<RedPointType, List<String>> getRedPointMap(Player player) {
		...
		//检查开服活动
//		Enumeration<FresherActivityItem> enumeration = player.getFresherActivityMgr().getEnumeration();
//		boolean openDayGif = false;
//		while(enumeration.hasMoreElements()){
//			FresherActivityItem activity = enumeration.nextElement();
//			if(activity.isFinish() && !activity.isGiftTaken()){
//				openDayGif = true;
//				break;
//			}
//		}
//		while(openDayGif){
//			map.put(RedPointType.HOME_WINDOW_OPEN_GIGT, Collections.EMPTY_LIST);
//		}
		return map;
	}
