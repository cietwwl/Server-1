...
namespace DataSyn
{
  ...
  public partial class MsgDataSyn : global::ProtoBuf.IExtensible
  {
    ...
    [global::ProtoBuf.ProtoMember(5, IsRequired = false, Name=@"groupId", DataFormat = global::ProtoBuf.DataFormat.Default)]
    ...
    public enum eSynOpType
    {
      ...
      [global::ProtoBuf.ProtoEnum(Name=@"UPDATE_PART_LIST", Value=6)]
      UPDATE_PART_LIST = 6
    }
    ...
    public enum eSynType
    {
      ...
      [global::ProtoBuf.ProtoEnum(Name=@"SECRETAREA_BASE_INFO", Value=3)]
      SECRETAREA_BASE_INFO = 3,
      ...
      [global::ProtoBuf.ProtoEnum(Name=@"SECRETAREA_DEFEND_TEAM_INFO", Value=6)]
      SECRETAREA_DEFEND_TEAM_INFO = 6,
      ...
      [global::ProtoBuf.ProtoEnum(Name=@"ActivityVitalityType", Value=70)]
      ActivityVitalityType = 70,
            
      [global::ProtoBuf.ProtoEnum(Name=@"ActivityDailyDiscountType", Value=71)]
      ActivityDailyDiscountType = 71,
            
      [global::ProtoBuf.ProtoEnum(Name=@"ActivityVipDiscountType", Value=72)]
      ActivityVipDiscountType = 72,
            
      [global::ProtoBuf.ProtoEnum(Name=@"ActivityRedEnvelopeType", Value=73)]
      ActivityRedEnvelopeType = 73,
            
      [global::ProtoBuf.ProtoEnum(Name=@"QuestionList", Value=80)]
      QuestionList = 80,
            
      [global::ProtoBuf.ProtoEnum(Name=@"GFBiddingData", Value=81)]
      GFBiddingData = 81,
            
      [global::ProtoBuf.ProtoEnum(Name=@"GFDefendArmyData", Value=82)]
      GFDefendArmyData = 82,
            
      [global::ProtoBuf.ProtoEnum(Name=@"GFightOnlineGroupData", Value=83)]
      GFightOnlineGroupData = 83,
            
      [global::ProtoBuf.ProtoEnum(Name=@"GFightOnlinePersonalData", Value=84)]
      GFightOnlinePersonalData = 84,
            
      [global::ProtoBuf.ProtoEnum(Name=@"GFightOnlineResourceData", Value=85)]
      GFightOnlineResourceData = 85,
            
      [global::ProtoBuf.ProtoEnum(Name=@"MajorData", Value=86)]
      MajorData = 86,
            
      [global::ProtoBuf.ProtoEnum(Name=@"GFightSimpleLeader", Value=87)]
      GFightSimpleLeader = 87,
            
      [global::ProtoBuf.ProtoEnum(Name=@"GFightFinalReward", Value=88)]
